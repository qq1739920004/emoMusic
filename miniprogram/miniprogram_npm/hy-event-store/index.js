...
__DEFINE__(1655036900847, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1655036900848,"./event-store":1655036900849}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1655036900848, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1655036900849, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1655036900848,"./utils":1655036900850}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1655036900850, function(require, module, exports) {
...
return __REQUIRE__(1655036900847);
})()
